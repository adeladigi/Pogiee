...
var hardList = ["surveillance", "chauffeur", "misspell", "intelligence", "pronunciation", "handkerchief", "questionnaire", "unconscious", "precocious", "idiosyncrasy",
 ...
 "fatuous", "impetuous", "Sacrilegious", "fallacious", "forbearance", "crescendo", "irresistible", "millennium", "inoculate", "supersede", "minuscule", "embarrass", "occurrence",
  "amorphous", "facetious", "equivocal", "redolent", "stratagem", "aplomb", "evangelical", "palatable", "salubrious", "ameliorate", "ineffable", "desultory", "meretricious",
  "malinger", "diffident", "reticent", "irascible", "mendacious","elucidate", "prevaricate", "specious", "esoteric", "lugubrious", "prattle", "neophyte", "despondent",  "blithe",
  "taciturn", "pertinacious", "compunction", "pulchritude", "stentorian", "forlorn", "loquacious","perfidious", "intransigent", "innocuous", "invective", "circumlocution", "ruminate",
  "calumny","ignominious", "serendipity", "pusillanimous", "raconteur", "impertinent", "repudiate", "lachrymose",  "arcane", "anachronism", "abnegation", "clairvoyant", "somnolent",
  "astute", "nettle", "soporific", "inculcate", "sycophant", "invidious", "quotidian", "sagacious", "ennui", "ethereal", "sanguine", "peripatetic", "impecunious", "obsequious", "temerity",
   "indolent", "prosaic", "saccharine", "inexorable", "obstreperous", "sentient", "phlegmatic", "prurient", "vociferous", "truculent", "ephemeral", "imperious", "amorous", "officious",
   "presumptuous", "felicitous", "equanimity", "peccadillo", "ingenuous", "sacrosanct", "bonhomie", "malediction", "indefatigable", "quiescent", "pugnacious", "acquiesce", "unequivocal"];
